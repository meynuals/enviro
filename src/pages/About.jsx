    ...
    >
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1, py: 10 }}>
        ...
        <Grid container spacing={6} sx={{ mb: 10 }}>
          <Grid item xs={12} md={12}>
            ...
            >
              ...
              >
                AirVocate, an advocacy for a renewed atmosphere. We breathe life
                into the call to{" "}
                <Box
                  component="span"
                ...
                , inspiring everyone to become mindful stewards of God's
                creation. Through every action and in every digital footprint,
                we spark awareness, responsibility, and hope for a cleaner,
                greener world.
              </Typography>
            </Paper>
          </Grid>
        ...
        >
          ...
          >
            As advocates of the environment, particularly in addressing air
            pollution, we raise awareness through our online platform on TikTok.
            We created and shared a Mini Educational Series that are short, fun,
            engaging, and educational. Through these videos, we hope to give
            background information on what air pollution is, how it affects us,
          ...
          >
            These small, everyday practices may seem minor, but collectively,
            they make a significant difference for our planet. This reminds us
            that change begins with awareness, and even the smallest step can
            help create cleaner air and a healthier environment for all.
          </Typography>
        </Paper>
        ...
        >
          ...
          >
            Air Pollution is an evident and rampant issue that continues to
            pervade both society and the environment. It has already caused
            significant damage, such as the deterioration of air quality, harm
            to human health, and the disruption of ecosystems. Prolonged
            exposure to polluted air leads to respiratory and cardiovascular
            diseases, while also accelerating climate change through the release
            of greenhouse gases.
          </Typography>
          <Typography
            sx={{
          ...
          >
            Addressing this issue matters because the air we breathe connects us
            all, and protecting it means protecting life itself.
          </Typography>
        </Paper>
        ...
        >
          ...
          >
            Connect with us on our social media and view our documented
            materials to see our stewardship at work!
          </Typography>
        ...
        >
          ...
          >
            As stewards of the environment, we are called to care for creation.
            Upholding this duty begins with collective action toward reducing
            air pollution and promoting sustainable practices. Through
            cooperation and awareness, we can foster a cleaner atmosphere and
