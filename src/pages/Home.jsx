...
export default function Home() {
  ...
  return (
    <Box sx={{ bgcolor: '#0A0E27', minHeight: '100vh', position: 'relative', overflow: 'hidden' }}>
      ...
      <Box sx={{
        ...
        right: 0,
        bottom: 0,
        background: 'radial-gradient(circle at 20% 30%, rgba(14, 165, 233, 0.15) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(6, 182, 212, 0.1) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(2, 132, 199, 0.08) 0%, transparent 50%)',
      ...
      <Box sx={{
        position: 'relative',
        background: 'linear-gradient(180deg, rgba(14, 165, 233, 0.9) 0%, rgba(6, 182, 212, 0.8) 50%, rgba(2, 132, 199, 0.9) 100%)',
        py: { xs: 12, md: 20 },
        overflow: 'hidden',
        '&::before': {
          content: '""',
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 2 }}>
          <Box sx={{ textAlign: 'center', color: 'white' }}>
            ...
            <Box sx={{ mb: 4, display: 'flex', justifyContent: 'center', gap: 3, flexWrap: 'wrap' }}>
              {[CloudIcon, AirIcon, TsunamiIcon, BoltIcon, FilterDramaIcon].map((Icon, i) => (
                <Avatar key={i} sx={{
                  width: 80,
                  height: 80,
            ...
            <Button variant="contained" size="large" href="#/about" sx={{
              fontSize: '1.5rem',
              fontWeight: 800,
              px: 8,
              py: 2.5,
      ...
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1, py: 10 }}>
        ...
        <Grid container spacing={4} sx={{ mt: 4 }}>
          {[
            { label: '7 Million', sublabel: 'Deaths per year from air pollution', color: '#0EA5E9' },
            { label: '4.2M', sublabel: 'Outdoor air pollution deaths annually', color: '#06B6D4' },
            { label: '99%', sublabel: 'Of world population breathes polluted air', color: '#0EA5E9' },
          ].map((stat, idx) => (
            <Grid item xs={12} md={4} key={idx}>
              <Paper sx={{
                ...
                p: 4,
                textAlign: 'center',
                boxShadow: `0 15px 50px ${stat.color}40`,
                transition: 'all 0.4s ease',
                '&:hover': {
                  transform: 'translateY(-10px)',
                  boxShadow: `0 25px 70px ${stat.color}60`,
                }
              }}>
                  ...
                  {environmentalEffects.map((effect, idx) => (
                    <ListItem key={idx} sx={{ px: 0, py: 1 }}>
                      <ListItemIcon sx={{ minWidth: 35 }}>
                        <CheckCircleIcon sx={{ color: '#0EA5E9', fontSize: 24 }} />
                      </ListItemIcon>
                      <ListItemText 
                        primary={effect}
                        primaryTypographyProps={{
                          sx: { fontSize: '1rem', color: '#E0F2FE', lineHeight: 1.5 }
                        }}
                      />
                    </ListItem>
                  ))}
        ...
        <Paper sx={{
          ...
          p: { xs: 4, md: 8 },
          mb: 15,
          boxShadow: '0 30px 100px rgba(14, 165, 233, 0.5)',
        }}>
          <Typography variant="h2" sx={{
            fontSize: { xs: '3rem', md: '5rem' },
            fontWeight: 900,
          ...
          <Typography sx={{
            ...
            Understanding air pollution through video
          </Typography>
          <Box sx={{
            position: 'relative',
            paddingBottom: '56.25%',
            ...
            boxShadow: '0 20px 80px rgba(14, 165, 233, 0.6)',
            '&:hover': {
              boxShadow: '0 30px 120px rgba(14, 165, 233, 0.8)',
            }
          }}>
            <iframe
              style={{
        ...
        <Box sx={{ mb: 15 }}>
          ...
          <Grid container spacing={6}>
                  ...
                  {individualActions.map((action, idx) => (
                    <ListItem key={idx} sx={{ px: 0, py: 1.5 }}>
                      <ListItemIcon sx={{ minWidth: 40 }}>
                        <CheckCircleIcon sx={{ color: '#0EA5E9', fontSize: 28 }} />
                      </ListItemIcon>
                      <ListItemText 
                        primary={action}
                        primaryTypographyProps={{
                          sx: { fontSize: '1.15rem', color: '#E0F2FE', lineHeight: 1.6, fontWeight: 500 }
                        }}
                      />
                    </ListItem>
                  ))}
            ...
            <Grid item xs={12} md={6}>
              <Paper sx={{
                background: 'linear-gradient(135deg, rgba(6, 182, 212, 0.25) 0%, rgba(14, 165, 233, 0.2) 100%)',
                backdropFilter: 'blur(30px)',
                ...
                <List>
                  {communityActions.map((action, idx) => (
                    <ListItem key={idx} sx={{ px: 0, py: 1.5 }}>
                      <ListItemIcon sx={{ minWidth: 40 }}>
                        <CheckCircleIcon sx={{ color: '#06B6D4', fontSize: 28 }} />
                      </ListItemIcon>
                      <ListItemText 
                        primary={action}
                        primaryTypographyProps={{
        ...
        <Paper sx={{
          ...
          <Box sx={{ position: 'relative', zIndex: 1 }}>
            ...
            <Typography sx={{
              ...
              Every small action counts. Join us in the fight for clean air and a sustainable future. Together, we can make a difference.
            </Typography>
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={3} justifyContent="center">
              ...
              <Button variant="outlined" size="large" href="#/team" sx={{
                fontSize: '1.4rem',
                fontWeight: 800,
                px: 8,
                py: 2.5,
