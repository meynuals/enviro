  ...
  return (
    <Box
      ...
      sx={{
        position: "relative",
        background:
          "linear-gradient(180deg, rgba(0, 0, 50, 1) 0%, rgba(14, 165, 233, 0.8) 100%)",
        color: "#BAE6FD",
        py: 8,
        mt: 15,
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
        <Grid container spacing={6} sx={{ mb: 6 }}>
          <Grid item xs={12} md={4}>
            ...
            >
              Fighting air pollution through education, advocacy, and community
              action. Every breath matters.
            </Typography>
          </Grid>
        ...
        >
          ...
          >
            © {new Date().getFullYear()} AirVocate. All rights reserved. | Every
            breath counts. 🌬️
          </Typography>
        </Box>
      </Container>
